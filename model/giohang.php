...
function insert_donhang($id_tai_khoan, $ho_ten, $dia_chi, $sdt, $email, $pttt, $tong_tien, $ngay_dat_hang, $trang_thai)
{
    try {
        $conn = pdo_get_connection();
        $stmt = $conn->prepare("INSERT INTO hoa_don(id_tai_khoan, ho_ten, dia_chi, sdt, email, pttt, tong_tien, ngay_dat_hang, trang_thai) VALUES (?,?, ?, ?, ?, ?, ?, ?, ?)");
        $stmt->execute([$id_tai_khoan, $ho_ten, $dia_chi, $sdt, $email, $pttt, $tong_tien, $ngay_dat_hang, $trang_thai]);
