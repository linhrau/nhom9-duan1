        ...
        <div class="row mb-3">
          ...
          <div class="col-sm-10">
            <div class="input-group input-group-merge">
              ...
              <textarea name="mo_ta_sp" id="mo_ta_sp" class="form-control" aria-describedby="basic-icon-default-message2"></textarea>
            </div>
...
<script>
  ...
  function validate() {
    ...
    if (ten_san_pham.value.trim() == "") {
      ten_san_pham_err.innerHTML = "Bạn chưa nhập tên";
      kt = false;
    } else {
      ten_san_pham_err.innerHTML = "";
    }
