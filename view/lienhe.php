                ...
                <div class="row">
                            ...
                            <div class="htc__contact__address">
                                ...
                                <div class="contact__address__inner">
                                    ...
                                    <div class="single__contact__address">
                                        ...
                                        <div class="contact__details">
                                            <p>Location : <br> 13 đường P. Trịnh Văn Bô, Xuân Phương, Nam Từ Liêm, Hà Nội</p>
                                        </div>
                                    </div>
                                    <!-- End Single Adress -->
                                </div>
                                <div class="contact__address__inner">
                                    ...
                                    <div class="single__contact__address">
                                        ...
                                        <div class="contact__details">
                                            <p> Phone : <br><a href="#">0975 679 310</a></p>
                                        </div>
                                    </div>
                                    <!-- End Single Adress -->
                                    <!-- Start Single Adress -->
                                    <div class="single__contact__address">
                                        ...
                                        <div class="contact__details">
                                            <p> Mail :<br><a href="#">huylong2074@gmail.com</a></p>
                                        </div>
                                    </div>
                                    <!-- End Single Adress -->
                                </div>
                                ...
                                <form action="index.php?act=contact" method="POST">
                                    <div class="single-contact-form">
                                        <div class="contact-box name">
                                            <input value="<?= $_SESSION['ten_dang_nhap']['ho_ten'] ?? '' ?>" type="text" name="ho_ten" placeholder="Họ tên">
                                            <input value="<?= $_SESSION['ten_dang_nhap']['email'] ?? '' ?>" type="email" name="email" placeholder="Email*">
                                        </div>
                                    </div>
                                    <div class="single-contact-form">
                                        <div class="contact-box subject">
                                            <input value="<?= $_SESSION['ten_dang_nhap']['sdt'] ?? '' ?>" type="text" name="sdt" placeholder="Sđt*">
                                        </div>
                                    </div>
                                    <div class="single-contact-form">
                                        <div class="contact-box message">
                                            <textarea name="noi_dung" name="message" placeholder="Nội dung*"></textarea>
                                        </div>
                                    </div>
                                    <div class="contact-btn">
                                        <!-- <button type="submit" name="send" class="fv-btn">Send</button> -->
                    ...
                    <div class="col-md-12 col-lg-6 col-sm-12 smt-30 xmt-30">
                        <div class="map-contacts">
                            <div id="googleMap">
                                <iframe src="https://www.google.com/maps/embed?pb=!1m18!1m12!1m3!1d3723.867173290914!2d105.74461987566839!3d21.038000087460336!2m3!1f0!2f0!3f0!3m2!1i1024!2i768!4f13.1!3m3!1m2!1s0x31345550b525aa03%3A0x3fdefc40f69a023a!2zVHLGsOG7nW5nIENhbyDEkOG6s25nIEZQVA!5e0!3m2!1sen!2s!4v1722492248368!5m2!1sen!2s" width="600" height="450" style="border:0;" allowfullscreen="" loading="lazy" referrerpolicy="no-referrer-when-downgrade"></iframe>
                            </div>
                        </div>
                    </div>
                </div>
