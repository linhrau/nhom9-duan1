                ...
                <div class="row">
                                ...
                                <form action="index.php?act=contact" method="POST">
                                    <div class="single-contact-form">
                                        <div class="contact-box name">
                                            <input value="<?= $_SESSION['user']['ho_ten'] ?? '' ?>" type="text"
                                                name="ho_ten" placeholder="Họ tên">
                                            <input value="<?= $_SESSION['user']['email'] ?? '' ?>" type="email"
                                                name="email" placeholder="Email*">
                                        </div>
                                    </div>
                                    <div class="single-contact-form">
                                        <div class="contact-box subject">
                                            <input value="<?= $_SESSION['user']['sdt'] ?? '' ?>" type="text" name="sdt"
                                                placeholder="Sđt*">
                                        </div>
                                    </div>
                                    <div class="single-contact-form">
                    ...
                    <div class="col-md-12 col-lg-6 col-sm-12 smt-30 xmt-30">
                        <div class="map-contacts">
                            <div id="googleMap">
                                <iframe
                                    src="https://www.google.com/maps/embed?pb=!1m18!1m12!1m3!1d3723.867173290914!2d105.74461987566839!3d21.038000087460336!2m3!1f0!2f0!3f0!3m2!1i1024!2i768!4f13.1!3m3!1m2!1s0x31345550b525aa03%3A0x3fdefc40f69a023a!2zVHLGsOG7nW5nIENhbyDEkOG6s25nIEZQVA!5e0!3m2!1sen!2s!4v1722492248368!5m2!1sen!2s"
